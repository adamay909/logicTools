...
To compile the LaTeX output you need the commands defined in logic\_commands.sty (included with the source files for the textbook available at [https://github.com/adamay909/logicbook](https://github.com/adamay909/logicbook).
