/*
Lbhelper is a program primarily designed for help with producing the logic [text book] at [https://github.com/adamay909/logicbook] but it can do some other things, too. It can:
...
**The LaTeX markup generated by lbhelper requires the use of custom commands defined in the style files included with the source files for the logic [text book].**
...
For this to work, you need:
  ...
  - the style files included with the source files of the [text book] installed somewhere the LaTeX compiler can find or in the same directory as the source file.

The needed style files also include commands to facilitate the creation of exercises so you can generate the exercises proper as well as the answer keys from the same LaTeX fragment. See the source files exercises included with the [text book] for some examples. You can compile answer keys using:
...
NOTE: Many of the source files for the exercises for the [text book] require enabling LaTeX to run lbhelper as an external command during compilation.
...
[text book]: https://github.com/adamay909/logicbook
